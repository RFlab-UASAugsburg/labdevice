...
%> the R&S RohdeUndSchwarz_ESRP by default couples the resolution bandwidth to the receiver frequency.
...
%> Detailed informations: RohdeUndSchwarz_ESRP_user_manual_en_08 p. 142
%>
