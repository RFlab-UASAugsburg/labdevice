%> @file HP_E3631A.m
%> @brief Keysight HP_E3631A 80W Triple Output Power Supply
% ======================================================
%> @brief Keysight HP_E3631A Power Supply 
%>
%> Usage:
%
%> Initalise subclass
%> @code
%> psu = HP_E3631A("gpib",... % mode
%>              6); % GPIB address
...
classdef HP_E3631A < labDevice
    properties
        
    end
    
    methods
        function obj = HP_E3631A(mode, varargin)
