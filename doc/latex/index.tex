...
\begin{DoxyCode}{0}
\DoxyCodeLine{sigGen = \mbox{\hyperlink{class_s_m_x}{SMX}}(\textcolor{stringliteral}{"gpib"},\% mode}
...
\DoxyCodeLine{interfaceConverter = \mbox{\hyperlink{class_pro_logix}{ProLogix}}(\textcolor{stringliteral}{'eth'},\% communication mode of converter}
...
\DoxyCodeLine{sigGen = \mbox{\hyperlink{class_s_m_x}{SMX}}(\textcolor{stringliteral}{"eth2gpib"},\% communication mode }
