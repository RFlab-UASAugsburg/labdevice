...
classdef  UASAugsburg_Stepper < labDevice
   ...
   methods 
        ...
        %>
        %> @return Instance of the UASAugsburg_Stepper class.
        % ======================================================================
       function obj = UASAugsburg_Stepper(mode, varargin)
           obj@labDevice(mfilename,mode, varargin);
           % add device specific constructor from here on
       end
        % ======================================================================
        %> @brief Delete UASAugsburg_Stepper Object
        %>
        %> The destructor 
        %>
